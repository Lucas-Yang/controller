...
import static com.example.myapplication.wifiConnect.TAG;
...
//然后是一个实际应用方法，只验证过没有密码的情况：
    ...
    public  int checkWifiPassword(Context context) {
          final int  WIFI_NEED_PASSWORD = 0;
         final int  WIFI_NO_PASSWORD = 1;
         final int  WIFI_NOT_CONNECTED = 2;

        final String WIFI_AUTH_OPEN = "";
         final String WIFI_AUTH_ROAM = "[ESS]";
